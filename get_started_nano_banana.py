...
MODEL_ID = "gemini-3.1-flash-image-preview" # @param ["gemini-2.5-flash-image", "gemini-3.1-flash-image-preview", "gemini-3-pro-image-preview"] {"allow-input":true, isTemplate: true}
