...
const MODES = [
  {
    ...
    placeholder: "Weekend vibes — brunch, shopping, golden hour walk...",
    vibes: [
  ...
  },
  {
    ...
    placeholder: "Dinner date at the Italian place downtown...",
    vibes: [
      "Night out downtown — cocktails and rooftop views",
      "Birthday brunch at the rooftop cafe",
      "Museum date — art and outfits",
  ...
  },
  {
    ...
    label: "Ad Creative",
    icon: "📦",
    desc: "You + a product — influencer-style sponsored content",
    placeholder: "Morning skincare routine with this vitamin C serum...",
    vibes: [
      "Morning coffee ritual with this tumbler",
      "Unboxing this new lipstick shade",
      "Workout with this protein shake",
