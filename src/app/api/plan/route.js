...
- ${angleInstruction}
- If "Selfie": perspective = "Close-up front-facing camera selfie, one extended arm holding the camera out of frame". The hand holding the camera is PERMANENTLY OCCUPIED and OUT OF FRAME. That gives the avatar EXACTLY 1 free hand. The free hand may hold ONE physical prop that exists naturally in the scene (e.g., a mug, a menu page, a hot water bottle). The free hand CANNOT hold a second phone or any screen-based device.
...
- If "Mirror Selfie": BOTH hands visible in reflection. One hand holds the phone UP to take the photo. The OTHER hand may pose or hold ONE item. The screen of the camera-phone CANNOT be seen. NEVER describe a second phone or a separate device being held to show the app — the phone in hand IS the only phone.
